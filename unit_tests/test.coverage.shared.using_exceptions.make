...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/test.coverage.shared.using_exceptions
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/test.coverage.shared.using_exceptions
  DEFINES   += -DDEBUG -D_DEBUG -DPLATFORM_CHECKED -DUNIX_BUILD -DOOLUA_RUNTIME_CHECKS_ENABLED=1 -DOOLUA_USE_SHARED_PTR=1 -DOOLUA_NEW_POINTER_DEFAULT_IS_SHARED_TYPE=0 -DOOLUA_STORE_LAST_ERROR=0 -DOOLUA_USE_EXCEPTIONS=1
...
ifeq ($(config),release)
  OBJDIR     = ../obj/Release/test.coverage.shared.using_exceptions
  TARGETDIR  = ../bin/Release
  TARGET     = $(TARGETDIR)/test.coverage.shared.using_exceptions
  DEFINES   += -DNDEBUG -DRELEASE -DPLATFORM_CHECKED -DUNIX_BUILD -DOOLUA_RUNTIME_CHECKS_ENABLED=1 -DOOLUA_USE_SHARED_PTR=1 -DOOLUA_NEW_POINTER_DEFAULT_IS_SHARED_TYPE=0 -DOOLUA_STORE_LAST_ERROR=0 -DOOLUA_USE_EXCEPTIONS=1
  INCLUDES  += -Iinclude/cppunit -Iinclude/gmock -Iinclude/lua -Iinclude -I/usr/local/include -I/usr/include -I../include -Ibind_classes -Icpp_classes -Itest_classes
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/shared_pointer.o \
	$(OBJDIR)/templated_class.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking test.coverage.shared.using_exceptions
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning test.coverage.shared.using_exceptions
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/shared_pointer.o: shared/shared_pointer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"

$(OBJDIR)/templated_class.o: shared/templated_class.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"

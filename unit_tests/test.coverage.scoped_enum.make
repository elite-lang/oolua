...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/test.coverage.scoped_enum
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/test.coverage.scoped_enum
  ...
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -g -Wall -Wextra -W -Wall -ansi -pedantic --std=c++0x -fprofile-arcs -ftest-coverage
...
ifeq ($(config),release)
  OBJDIR     = ../obj/Release/test.coverage.scoped_enum
  TARGETDIR  = ../bin/Release
  TARGET     = $(TARGETDIR)/test.coverage.scoped_enum
  DEFINES   += -DNDEBUG -DRELEASE -DPLATFORM_CHECKED -DUNIX_BUILD
  INCLUDES  += -Iinclude/cppunit -Iinclude/gmock -Iinclude/lua -Iinclude -I/usr/local/include -I/usr/include -I../include -Ibind_classes -Icpp_classes -Itest_classes
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -O2 -Wall -Wextra -W -Wall -ansi -pedantic --std=c++0x -fprofile-arcs -ftest-coverage
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking test.coverage.scoped_enum
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning test.coverage.scoped_enum
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/scoped_enum_c++11.o: scoped_enum/scoped_enum_c++11.cpp
	@echo $(notdir $<)

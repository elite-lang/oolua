...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/test.coverage.shared
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/test.coverage.shared
  DEFINES   += -DDEBUG -D_DEBUG -DPLATFORM_CHECKED -DUNIX_BUILD -DOOLUA_RUNTIME_CHECKS_ENABLED=1 -DOOLUA_USE_SHARED_PTR=1 -DOOLUA_NEW_POINTER_DEFAULT_IS_SHARED_TYPE=0 -DOOLUA_STORE_LAST_ERROR=1 -DOOLUA_USE_EXCEPTIONS=0
...
ifeq ($(config),release)
  OBJDIR     = ../obj/Release/test.coverage.shared
  TARGETDIR  = ../bin/Release
  TARGET     = $(TARGETDIR)/test.coverage.shared
  DEFINES   += -DNDEBUG -DRELEASE -DPLATFORM_CHECKED -DUNIX_BUILD -DOOLUA_RUNTIME_CHECKS_ENABLED=1 -DOOLUA_USE_SHARED_PTR=1 -DOOLUA_NEW_POINTER_DEFAULT_IS_SHARED_TYPE=0 -DOOLUA_STORE_LAST_ERROR=1 -DOOLUA_USE_EXCEPTIONS=0
  INCLUDES  += -Iinclude/cppunit -Iinclude/gmock -Iinclude/lua -Iinclude -I/usr/local/include -I/usr/include -I../include -Ibind_classes -Icpp_classes -Itest_classes
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking test.coverage.shared
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning test.coverage.shared
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else

...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/test.coverage.string_is_integral
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/test.coverage.string_is_integral
  DEFINES   += -DDEBUG -D_DEBUG -DPLATFORM_CHECKED -DUNIX_BUILD -DOOLUA_RUNTIME_CHECKS_ENABLED=1 -DOOLUA_STD_STRING_IS_INTEGRAL=1 -DOOLUA_SAFE_ID_COMPARE=0 -DOOLUA_STORE_LAST_ERROR=1 -DOOLUA_USE_EXCEPTIONS=0
...
ifeq ($(config),release)
  OBJDIR     = ../obj/Release/test.coverage.string_is_integral
  TARGETDIR  = ../bin/Release
  TARGET     = $(TARGETDIR)/test.coverage.string_is_integral
  DEFINES   += -DNDEBUG -DRELEASE -DPLATFORM_CHECKED -DUNIX_BUILD -DOOLUA_RUNTIME_CHECKS_ENABLED=1 -DOOLUA_STD_STRING_IS_INTEGRAL=1 -DOOLUA_SAFE_ID_COMPARE=0 -DOOLUA_STORE_LAST_ERROR=1 -DOOLUA_USE_EXCEPTIONS=0
  INCLUDES  += -Iinclude/cppunit -Iinclude/gmock -Iinclude/lua -Iinclude -I/usr/local/include -I/usr/include -I../include -Ibind_classes -Icpp_classes -Itest_classes
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking test.coverage.string_is_integral
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning test.coverage.string_is_integral
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
